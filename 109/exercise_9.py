...
def get_workout_motd(day):
    ...
    if day.capitalize() not in WORKOUT_SCHEDULE:
        current_day = INVALID_DAY
    else:
        workout = WORKOUT_SCHEDULE.get(day.capitalize())
        workout_by_day = TRAIN.replace("{}", workout)
        current_day = workout_by_day if workout != REST else CHILL_OUT
